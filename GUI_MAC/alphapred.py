...
from alphaml import prediction
...
c01r11_label = tk.Label(c01r11_frame, text="Predict test data using a CLETE Model", font=("Helvetica", 12),
                        fg="blue", anchor="sw")
...
c45r11_label = tk.Label(c45r11_frame, text="CLETE- Clear, Legible, Explainable, Transparent and Elucidative",
                        font=("Helvetica", 12), fg="blue", anchor="se")
...
col_label_entry.grid(row=1, column=1, padx=13, pady=5)
...
pos_entry.grid(row=2, column=1, padx=13, pady=5)
...
neg_entry.grid(row=3, column=1, padx=13, pady=5)
...
cancel_button.grid(row=5, column=2, columnspan=2, rowspan=1, padx=5, pady=5)  # , sticky="e")
cancel_button.config(width=46)
