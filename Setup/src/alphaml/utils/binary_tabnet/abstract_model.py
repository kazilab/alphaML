...
class TabModel(BaseEstimator):
    ...
    optimizer_params: Dict = field(default_factory=lambda: dict(lr=2e-2, weight_decay=1e-5))
    scheduler_fn: Any = torch.optim.lr_scheduler.StepLR  # None
    scheduler_params: Dict = field(default_factory=lambda: dict(step_size=10, gamma=0.9))
