...
def optuna_(data,
    ...
    def objective(trial):
        hidden_layer_sizes = trial.suggest_categorical("hidden_layer_sizes", [16, 25, 32, 50, 64, 100,
                                                                              128, 200, 256, 400, 512])
        max_iter = trial.suggest_int("max_iter", 100, 500, step=50)

        params_ = dict(hidden_layer_sizes=hidden_layer_sizes,
                       max_iter=max_iter,
                       verbose=0
                       )
...
def bayes_(data,
    ...
    space = {'hidden_layer_sizes': Categorical([16, 25, 32, 50, 64, 100, 128, 200, 256, 400, 512]),
             'max_iter': Categorical([100, 150, 200, 250, 300, 350, 400, 450, 500]),
             }
...
def grid_(data,
    ...
    space = {'hidden_layer_sizes': [16, 25, 32, 50, 64, 100, 128, 200, 256, 400, 512],
...
def predefined_(data,
    ...
    parameters = {'hidden_layer_sizes': (512, 256, 128),
                  'max_iter': 500,
                  'random_state': random_state
                  }
    model, performance = model_(data=data,
